      ...
      <div className="d-tablecell">
        <div className="container">
          <div className="banner-text text-center">
            <h1>فطور صحي للأطفال في الروضة </h1>
            <ul>
              <li>
                <a href="/">الصفحة الرئيسية</a>
                <i className="flaticon-right-arrow" />
              </li>
              <li>فطور صحي للأطفال في الروضة</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div className="single-blog">
              <div className="blog-image">
                <div className="single-img">
                  <ExportedImage unoptimized={true} src="/images/9.jpg" alt="ExportedImage" height={480} width={736}/>
                </div>
              </div>
              <div className="blog-content">
                {/* <ul class="blog-meta">
                                  ...
                                  <li><i class="fa fa-heart-o" aria-hidden="true"></i>2 like</li>
                              </ul> */}
