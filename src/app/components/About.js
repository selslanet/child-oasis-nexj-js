      ...
      <>
        ...
        <section className="about-section ap-about-section ptb-100">
              ...
              <div className="col-lg-6">
                <div className="single-about-bg item-bg">
                  <div className="about-img-cartwrap">
                    <div className="image">
                      <ExportedImage  unoptimized={true} src="/images/about-bg.png" alt="" width={270} height={598} />
          ...
          <div className="shape1">
            <ExportedImage  unoptimized={true} src={shape1} alt="ExportedImage" width={43} height={45} />
          </div>
          <div className="shape2">
            <ExportedImage  unoptimized={true} src={shape2} alt="ExportedImage" width={56} height={60} />
          </div>
          <div className="shape3">
            <ExportedImage  unoptimized={true} src={shape3} alt="ExportedImage" width={70} height={75} />
          </div>
          <div className="shape4">
            <ExportedImage  unoptimized={true} src={shape4} alt="ExportedImage" width={50} height={50} />
          </div>
        </section>
        {/* End About Section */}
        {/* Services Section */}
                ...
                <div className="single-service">
                  <div className="services-all">
                    <div className="image">
                      <a href="#">
                        <ExportedImage
                           unoptimized={true} src="/images/ico1.png"
                ...
                <div className="single-service">
                  <div className="services-all">
                    <div className="image">
                      <a href="#">
                        <ExportedImage
                           unoptimized={true} src="/images/ico2.png"
                          className="wow fadeInLeft"
                          alt="ExportedImage"
                          width={47}
                          height={49}
                ...
                <div className="single-service">
                  <div className="services-all">
                    <div className="image">
                      <a href="#">
                        <ExportedImage
                           unoptimized={true} src="/images/ico3.png"
                          className="wow fadeInLeft"
                          alt="ExportedImage"
                          width={57}
                          height={58}
            ...
            <div className="row">
              <div className="col-md-6 col-lg-4">
                <div className="single-baby">
                  <div className="image">
                    <a href="#">
                      <ExportedImage  unoptimized={true} src="/images/1-1.png" alt="ExportedImage" width={296} height={230} />
                    </a>
                  </div>
